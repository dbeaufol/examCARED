...
<!--Accueil Test js-->
  ...
  @if(Auth::check())
    ...
    <br/>
  @endif
  <div id="box" style="background:rgb(250,250,250);height:100px;width:100px;margin:6px;font-style: italic;">Ceci est ma page d'acceuil et un example simple de javascript</div>
